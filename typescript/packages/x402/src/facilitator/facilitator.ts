...
>(
  ...
  console.error(
    "X402 Log: Main Facilitator verify - Scheme or network not supported by EVM exact verifier",
    { scheme: paymentRequirements.scheme, network: paymentRequirements.network, supportedNetworks: SupportedEVMNetworks }
  );
  return {
    isValid: false,
...
export async function settle<transport extends Transport, chain extends Chain>(
  ...
  console.error(
    "X402 Log: Main Facilitator settle - Scheme or network not supported by EVM exact settler",
    { scheme: paymentRequirements.scheme, network: paymentRequirements.network, supportedNetworks: SupportedEVMNetworks }
  );
  return {
    success: false,
